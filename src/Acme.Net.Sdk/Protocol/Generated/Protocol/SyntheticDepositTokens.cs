...
{
    /// <summary>
    /// Represents a synthetic transaction for depositing tokens into token accounts.
    /// </summary>
    [JsonObject(MemberSerialization.OptIn)]
    [JsonConverter(typeof(TransactionBodyConverter))]
    public class SyntheticDepositTokens : ITransactionBody
    {
        /// <summary>
        /// Gets the transaction type.
        /// </summary>
        [JsonProperty("type")]
        public string Type => "syntheticDepositTokens";
        ...
        /// <summary>
        /// Gets or sets the amount of tokens to deposit.
        /// </summary>
        [JsonProperty("amount")]
        public BigInteger Amount { get; set; }

        /// <summary>
        /// Creates a new instance of SyntheticDepositTokens.
        /// </summary>
        public SyntheticDepositTokens()
        {
        }
        ...
        public byte[] MarshalBinary()
        {
            ...
            marshaller.WriteUInt(1, TransactionTypeCode.SyntheticDepositTokens);
            ...
            // Marshal token as field 3
            if (Token != null)
            {
                marshaller.WriteValue(3, Token);
            }
            
            // Marshal amount as field 4
            marshaller.WriteBytes(4, Amount.ToByteArray());
