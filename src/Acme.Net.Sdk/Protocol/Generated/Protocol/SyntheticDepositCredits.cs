...
{
    /// <summary>
    /// Represents a synthetic transaction for depositing credits into a credit holder.
    /// </summary>
    [JsonObject(MemberSerialization.OptIn)]
    [JsonConverter(typeof(TransactionBodyConverter))]
    public class SyntheticDepositCredits : ITransactionBody
    {
        /// <summary>
        /// Gets the transaction type.
        /// </summary>
        [JsonProperty("type")]
        public string Type => "syntheticDepositCredits";
        ...
        /// <summary>
        /// Gets or sets the amount of credits to deposit.
        /// </summary>
        [JsonProperty("amount")]
        public BigInteger Amount { get; set; }

        /// <summary>
        /// Creates a new instance of SyntheticDepositCredits.
        /// </summary>
        public SyntheticDepositCredits()
        {
        }
        ...
        public byte[] MarshalBinary()
        {
            ...
            marshaller.WriteUInt(1, TransactionTypeCode.SyntheticDepositCredits);
